          ...
          <div className="lg:col-span-8">
            <form onSubmit={handleSubmit} className="bg-white shadow rounded-lg p-6">
              <div className="space-y-6">
                ...
                <div>
                  <label htmlFor="purchaserPhone" className="block text-sm font-medium text-gray-700">
                    Your Phone Number
                  </label>
                  <input
                    type="tel"
                ...
                <div>
                  <label htmlFor="customNote" className="block text-sm font-medium text-gray-700">
